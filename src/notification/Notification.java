...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/success.gif")));
            lbMessage.setText("Success");
        } else if (type == Type.UPDATE) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/update.gif")));
            lbMessage.setText("Updated");           
        }else if(type == Type.DELETE){
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/delete.gif")));
            lbMessage.setText("Deleted");
        }else if(type == Type.DONE){ 
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/done.gif")));
            lbMessage.setText("Completed");
        }else if(type == Type.PRINT){  
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/print.gif")));
            lbMessage.setText("Printed");
        }else if(type == Type.MAIL){  
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/mail2.gif")));
            lbMessage.setText("Mail Send");
        }
    ...
    private void initComponents() {
        ...
        lbMessage.setFont(new java.awt.Font("Montserrat", 1, 14)); // NOI18N
        lbMessage.setForeground(new java.awt.Color(38, 38, 38));
        lbMessage.setText("Message");

        lbMessageText.setFont(new java.awt.Font("Montserrat", 0, 12)); // NOI18N
    ...
    public static enum Type {
        SUCCESS, UPDATE, WARNING , DELETE, DONE, PRINT, MAIL
    }
